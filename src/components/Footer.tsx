        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8 mb-12">
          ...
          <div>
            <Link href="/" className="flex items-center gap-2 mb-4">
              ...
              <span
                className="text-lg"
                style={{ fontFamily: "'Playfair Display', Georgia, serif", fontWeight: 600, color: 'white' }}
              >
                Syntax Lab
              </span>
            </Link>
          ...
          {/* Column 2: Learn */}
          <div>
            <h4 className="text-sm font-semibold mb-4" style={{ color: 'rgba(255,255,255,0.9)' }}>Learn</h4>
            <ul className="space-y-3">
              {learnLinks.map((link) => (
                <li key={link.label}>
                  <Link href={link.href}
                    className="text-sm transition-colors duration-[var(--duration-fast)] hover:text-[rgba(255,255,255,0.9)]"
                    style={{ color: 'rgba(255,255,255,0.6)' }}>{link.label}</Link>
                </li>
              ))}
            </ul>
          </div>
          ...
          {/* Column 3: Account */}
          <div>
            <h4 className="text-sm font-semibold mb-4" style={{ color: 'rgba(255,255,255,0.9)' }}>Account</h4>
            <ul className="space-y-3">
          ...
          {/* Column 4: About + Feedback */}
          <div>
            <h4 className="text-sm font-semibold mb-4" style={{ color: 'rgba(255,255,255,0.9)' }}>About</h4>
            ...
            <h4 className="text-sm font-semibold mb-3" style={{ color: 'rgba(255,255,255,0.9)' }}>
              <Mail className="w-3.5 h-3.5 inline mr-1" />
              Feedback & Suggestions
            </h4>
            <a href="mailto:279364248@qq.com" className="text-sm transition-colors hover:text-[rgba(255,255,255,0.9)]"
